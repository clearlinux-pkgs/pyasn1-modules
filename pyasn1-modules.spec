...
Version  : 0.0.9
Release  : 15
URL      : https://pypi.debian.net/pyasn1-modules/pyasn1-modules-0.0.9.tar.gz
Source0  : https://pypi.debian.net/pyasn1-modules/pyasn1-modules-0.0.9.tar.gz
...
%prep
%setup -q -n pyasn1-modules-0.0.9
...
export LANG=C
export SOURCE_DATE_EPOCH=1496358325
